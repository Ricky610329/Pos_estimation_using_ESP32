...
CONTROL_IP   = '172.20.10.3' #change here to control ip
PORT_NUMBER = 5000
LISTEN_PORT = 5001
SIZE = 1024
ESPNUM =  2#change here to the number of esp32 you using
...
print(data)
raspname = data.decode('utf-8')
for i in range(ESPNUM):
    serial_thread.append(threading.Thread(target = monitor[i].Serial_save,args=(raspname,str(i),mySocket,COM_PORT[i])))
